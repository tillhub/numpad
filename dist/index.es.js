...
var StyledButton = styled.div(_templateObject, function (_ref) {
  var disabled = _ref.disabled;
  return disabled === false && css(_templateObject2);
}, function (_ref2) {
  var disabled = _ref2.disabled;
  return disabled && css(_templateObject3);
});
...
function Keypad(_ref) {
  ...
  return React.createElement(
    ...
    React.createElement(Buttons, { clickHandler: clickHandler, disabled: disabled }),
    React.createElement(
      StyledZeroButton,
      {
        text: '0',
...
var StyledWrapper = styled.div(_templateObject$2);
